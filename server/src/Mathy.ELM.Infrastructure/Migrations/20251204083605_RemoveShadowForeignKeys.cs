...
namespace Mathy.ELM.Infrastructure.Migrations
{
    ...
    public partial class RemoveShadowForeignKeys : Migration
    {
        ...
        {
            // Drop redundant shadow FK columns from PromotionRequestDetails
            // These were creating circular dependencies - FK should only be on child tables
            ...
            // Drop redundant shadow FK columns from PT* child tables
            // These are duplicates of PTRequestDetailId
            migrationBuilder.DropForeignKey(
        ...
        {
            // Re-add shadow FK columns to PromotionRequestDetails
            ...
            // Re-add shadow FK columns to PT* child tables
            migrationBuilder.AddColumn<int>(
                name: "PromotionRequestDetailId",
                table: "PTApplicationRequests",
                type: "int",
