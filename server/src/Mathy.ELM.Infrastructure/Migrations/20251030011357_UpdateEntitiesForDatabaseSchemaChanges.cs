...
{
    /// <inheritdoc />
    public partial class UpdateEntitiesForDatabaseSchemaChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Add Recipients column to EmailTemplates table (also in InitialCreate for new databases)
